...
class MainWindow(QMainWindow):
    ...
    def _setup_menus(self) -> None:
        ...
        self._new_project_action = file_menu.addAction("Projekt — Neu")
        ...
        self._save_music_action = file_menu.addAction("Noten speichern")
        self._save_music_action.setShortcut(QKeySequence("Alt+S"))
        ...
        self._save_project_action = file_menu.addAction("Projekt speichern")
        self._save_project_action.setShortcut(QKeySequence.StandardKey.Save)
        self._save_project_as_action = file_menu.addAction("Projekt speichern unter...")
